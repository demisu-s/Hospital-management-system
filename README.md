...
![image](https://github.com/user-attachments/assets/82cb1a0a-1140-4338-b98b-5ac2638389f2)
...
If you're getting started and need assistance or face any bugs, join our active Discord community with members. It's a place where people help each other out.

<a href="https://discord.com/channels/1263857856763924613/1263857856763924617" target="_blank"></a>
...
```bash
git clone git@github.com:demisu-s/Hospital-management-system.git
cd healthcare
```
